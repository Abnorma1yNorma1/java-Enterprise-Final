package by.it_academy.jd2.Mk_jd2_111_25.user_service.config;

import by.it_academy.jd2.Mk_jd2_111_25.user_service.common.dto.ErrorResponse;
import by.it_academy.jd2.Mk_jd2_111_25.user_service.controller.filter.JwtFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtFilter filter) throws Exception {
        ...
        http.cors(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/users/new").hasRole("SERVICE")
